Public Class Cliente
    ...
    Public Property Nombre As String
        ...
        Set(value As String)
            ...
            If value = "" Then
                Throw New ArgumentException("No puede dejar el Nombre vacio")
    ...
    Public Sub addCuenta(Cuenta As Cuenta)
        If _cuentas.Count = 2 Then
            Throw New GeneralException("Ya se alcanzo el limite de cuentas. No se pudo agregar la cuenta: ", Cuenta.Numero, Cuenta.ToString)
        End If
